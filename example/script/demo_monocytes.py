...
mtx = data_path + 'cd14_monocyte_erythroid.mtx'
x = read_mtx(mtx)
...
## Building the model
model = SCPHERE(n_gene=x.shape[1], n_batch=n_batch, batch_invariant=False, z_dim=2, latent_dist='wn', observation_dispersion='gene')
model.train()
